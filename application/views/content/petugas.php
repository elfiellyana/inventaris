 <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Petugas</h2>
                                    ...
                                    <table class="table table-striped order-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('control/page/f_petugas'); ?>/<?php echo $tampil->id_petugas; ?>" class="far fa-edit" title="Edit" data-toggle="tooltip" data-placement="Left"></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?php echo site_url('control/hapus_petugas'); ?>/<?php echo $tampil->id_petugas; ?>" class="btn btn-primary">Yakin</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>