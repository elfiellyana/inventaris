...
<div class="kotak">
	...
	<div style="width:50%;float: right">
		<div style="text-align: center;">
			...
			<p><?php echo tanggal_indo(date('Y-m-d'),true) ?></p><br>
